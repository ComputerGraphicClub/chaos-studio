...
document.addEventListener('scroll', function (ev) {
    ...
    if (isInViewportY(projectArea[0])) {
        descIconColor.innerHTML = ".cross#description:before {background: rgb(0, 240, 0);} .cross#description:after {background: rgb(0, 240, 0);}";
    }

    else {
        descIconColor.innerHTML = ".cross#description:before {background: rgb(200, 0, 0);}  .cross#description:after {background: rgb(200, 0, 0);}";
    }
